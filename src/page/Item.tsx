...
const Item = ({ isCustom = false }: ItemProps) => {
  ...
  if (isLoading) return <div className="text-center"><svg aria-hidden="true" role="status" className="inline w-4 h-4 me-3 text-gray-200 animate-spin dark:text-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    ...
    <main className="max-w-xl mx-auto px-4 py-8 mt-20">
      ...
      <div className="mt-6 text-center text-sm text-gray-700">
        ...
        <p>Género: <b>{'gender' in data ? (data as any).gender : 'Desconocido'}</b></p>
      </div>
