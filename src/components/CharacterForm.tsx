...
const CharacterForm = ({ onSubmit, defaultValues, title, buttonText, isSubmitting }: CharacterFormProps) => {
  const {
    register,
    handleSubmit,
    setValue,
    ...
    <>
      ...
      >
        ...
        <button
          ...
          className={`flex items-center justify-center font-semibold px-4 py-2 rounded-md border transition-colors duration-200 
